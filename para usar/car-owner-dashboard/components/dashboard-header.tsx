  ...
  return (
    <header className="flex items-center justify-between px-4 py-4 md:px-6">
      <div>
        ...
        <h1 className="text-xl font-bold text-foreground">Carlos M.</h1>
      </div>
      <div className="flex items-center gap-2">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="relative rounded-full text-muted-foreground hover:text-foreground hover:bg-secondary"

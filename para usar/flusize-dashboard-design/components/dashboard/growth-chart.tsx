      ...
      <div className="rounded-lg border border-border bg-card px-3 py-2 shadow-lg">
        ...
        {payload.map((entry) => (
          <p key={entry.dataKey} className="text-xs text-muted-foreground">
            {entry.dataKey === "talleres" ? "Talleres" : "Ordenes"}:{" "}
        ...
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-base font-semibold text-foreground">
              Crecimiento de Talleres
            </CardTitle>
            <CardDescription className="text-xs text-muted-foreground">
              Crecimiento exponencial en los ultimos 6 meses
            </CardDescription>
          </div>
      ...
      <CardContent className="pt-2">
        ...
        <div className="mt-3 flex items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground">Ordenes Procesadas</span>
          </div>
        </div>
      </CardContent>
    </Card>

            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 z-10 w-full">
                <div className="w-full max-w-sm">
                    ...
                    <Tabs defaultValue="conductor" className="w-full">
                        <TabsList className="grid w-full grid-cols-2 mb-6 h-auto p-1 bg-slate-100 rounded-xl">
                            <TabsTrigger value="conductor" className="py-2.5 rounded-lg font-semibold text-slate-600 data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm">Soy Conductor</TabsTrigger>
                            <TabsTrigger value="taller" className="py-2.5 rounded-lg font-semibold text-slate-600 data-[state=active]:bg-white data-[state=active]:text-slate-900 data-[state=active]:shadow-sm">Soy Taller</TabsTrigger>
                        </TabsList>
                                ...
                                {status === 'success' ? (
                                    <div className="text-center animate-in fade-in zoom-in duration-300">
                                        ...
                                        <p className="text-sm text-slate-500 mb-6">
                                            Revisa tu correo <b>{email}</b> y haz clic en el botón para entrar directamente.
                                        </p>
                                        <Button
                                            variant="outline"
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <Button
                                            ...
                                            variant="outline"
                                            className="w-full h-14 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-2xl text-base font-bold shadow-sm transition-all flex items-center justify-center gap-3"
                                        >
                                            {status === 'loading' ? (
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="relative flex justify-center text-xs uppercase">
                                                <span className="bg-white px-2 text-slate-400 font-bold tracking-widest">o con tu correo</span>
                                            </div>
                                        </div>
                                        ...
                                        <form onSubmit={handleMagicLinkLogin} className="space-y-4">
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-14 pl-12 bg-slate-50 border-slate-200 text-slate-900 rounded-2xl focus-visible:ring-blue-500 focus-visible:ring-offset-0 text-base shadow-sm"
                                                    required
                                                />
                                            </div>
                                            <Button
                                                type="submit"
                                                disabled={status === 'loading'}
                                                className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl text-base font-bold shadow-lg shadow-blue-600/20 active:scale-[0.98] transition-all"
                                            >
                                                {status === 'loading' ? (
                                                    <Loader2 className="w-5 h-5 animate-spin" />
                                                ) : (
                                ...
                                {status === 'success' ? (
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="relative flex justify-center text-xs uppercase">
                                                <span className="bg-white px-2 text-slate-400 font-bold tracking-widest">o con contraseña</span>
                                            </div>
                                        </div>

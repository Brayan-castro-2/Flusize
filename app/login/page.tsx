                ...
                <div className="w-full max-w-sm">
                    ...
                    <Tabs defaultValue="conductor" className="w-full">
                        ...
                        <TabsContent value="conductor">
                            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl shadow-slate-200/50 mb-6 flex flex-col items-center justify-center gap-4">
                                <p className="text-sm text-slate-600 text-center mb-2">
                                    Ingresa con tu cuenta de Google para acceder a todas las funcionalidades.
                                </p>
                                <Button
                                    type="button"

      ...
      <div className="max-w-4xl mx-auto px-4 text-center z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
            Conectamos tu taller con el cliente en tiempo real. Adi├│s a las llamadas infinitas. Bienvenido a la digitalizaci├│n absoluta y satisfacci├│n garantizada.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight mb-6">
              Elimina las llamadas preguntando <span className="text-blue-600 underline decoration-blue-200 underline-offset-4">┬┐est├í listo mi auto?</span>
            </h2>
            <p className="text-lg text-slate-500 mb-8 leading-relaxed">
              Env├¡a un <strong>Link M├ígico</strong> por WhatsApp. Tu cliente ve el avance en tiempo real, desde el diagn├│stico hasta la entrega, con la cotizaci├│n transparente siempre a mano.
            </p>
            <ul className="space-y-4">
              {[
                "L├¡nea de tiempo en vivo autom├ítica",
                "Transparencia que genera confianza absoluta",
                "Zero fricci├│n log├¡stica para tu equipo"
              ].map((item, i) => (
            ...
            <div className="flex flex-col gap-6 items-center relative z-10 w-full px-10">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-800 text-sm">Link M├ígico Recibido</p>
                    <p className="text-xs text-slate-400">"El auto est├í en reparaci├│n"</p>
                  </div>
                </div>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-tight mb-6">
              Tu competencia ya est├í recibiendo <span className="text-cyan-400">clientes desde nuestro mapa.</span> ┬┐Y t├║?
            </h2>
            <p className="text-lg text-slate-400 leading-relaxed">
              Al registrarte, tu taller aparece en el mapa p├║blico. Miles de conductores buscan servicios especializados diariamente y cotizan mediante un clic a WhatsApp.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-row-reverse">
          ...
          >
            ...
            <div className="bg-slate-800 rounded-2xl p-4 mb-4 flex gap-4">
              ...
              <div>
                <p className="text-slate-400 text-xs">Inversi├│n anual</p>
          ...
          >
            ...
            <p className="text-lg text-slate-500 mb-8 leading-relaxed">
              <strong>Mi Garage</strong> consolida todo lo que pasa con tus veh├¡culos. Todas las reparaciones, inversiones, fechas y recambios bajo control, inmutable y disponible en cualquier momento de manera gratuita.
            </p>
  ...
  const plans = [
    {
      ...
      features: [
        'Perfil p├║blico en el Mapa Flusize.',
        'Perfil Link-in-Bio para tus redes.',
        'Bot├│n de contacto directo a tu WhatsApp.',
        'Integraci├│n con todas tus redes sociales.'
      ],
      popular: false,
    ...
    },
    {
      ...
      features: [
        ...
        'Transparencia Total: Link M├ígico de seguimiento.',
        'Historial de ├│rdenes (hasta 15 d├¡as).',
        'Agregar y eliminar mec├ínicos de tu equipo.',
        'Env├¡o de boletas/comprobantes al cliente.'
      ],
      popular: true,
      waLink: "https://wa.me/56975243510?text=Hola,%20quiero%20el%20Plan%20Pro%20Tracking%20con%20el%20Link%20M├ígico",
    },
    {
      ...
      features: [
        ...
        'Historial de ├│rdenes ilimitado.',
        'Panel SaaS completo (Gesti├│n avanzada).',
        'Reportes financieros y de inversi├│n B2B.',
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
              Planes dise├▒ados para tu <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">crecimiento</span>
            </h2>
            <p className="text-lg text-slate-500 font-medium">
              Elige el plan que mejor se adapte a las necesidades de tu centro automotriz y comienza a digitalizar tu operaci├│n hoy mismo.
            </p>
          </motion.div>
        </div>
  ...
  <footer className="bg-white text-slate-500 py-16 border-t border-slate-100">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex gap-6 text-sm font-medium">
        ...
        <a href="#" className="hover:text-cyan-600 transition-colors">T├®rminos</a>
      </div>

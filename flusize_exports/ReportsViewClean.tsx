...
export default function ReportsView({ data, period }: ReportsViewProps) {
    ...
    const handleGenerateSummary = async () => {
        ...
        try {
            // TODO: Integración Supabase Edge Functions (AI Summary)
            // Ejemplo: const { data } = await supabase.functions.invoke('generate-summary', { body: { reportData: data } })
            setSummary("Este es un resumen generado localmente (Placeholder).");
        } catch (e) {
            // Silent fail
        } finally {
